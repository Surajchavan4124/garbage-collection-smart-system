...
export const getDashboardStats = async (req, res) => {
  try {
    const panchayatId = req.user.panchayat; // Use .panchayat from updated middleware
    ...
    // 2.1 Get Panchayat Name
    const panchayat = await Panchayat.findById(panchayatId); // Ensure Panchayat model is imported
    ...
    res.json({
      ward: employee.ward,
      panchayatName: panchayatName, // Added Field
      employeeName: user.name,      // Added Field (User name)
      total: totalBins,
