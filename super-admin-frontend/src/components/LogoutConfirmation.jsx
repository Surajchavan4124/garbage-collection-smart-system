  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white border border-gray-300 rounded-xl shadow-2xl w-full max-w-md mx-auto">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-6 py-4 rounded-t-xl">
        ...
        <div className="p-8 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <button
              onClick={onClose}
              className="px-8 py-3 bg-teal-600 text-white font-semibold text-sm rounded-lg hover:bg-teal-700 transition-all shadow-lg"
            >
              Stay Logged In
            </button>
          </div>
